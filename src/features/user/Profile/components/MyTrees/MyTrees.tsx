...
export default function MyTrees({ profile, authenticatedType, token }: Props) {
  ...
  const _contributions = [
    {
      ...
      plantProject: {
        ...
        geoJson: {
          ...
          geometry: {
            type: 'Point',
            coordinates: [24.448663786063683, 74.47891682493132],
          },
        },
        tpo: {
          id: 22408,
    ...
    },
    {
      ...
      plantProject: {
        ...
        geoJson: {
          ...
          geometry: {
            type: 'Point',
            coordinates: [28.19781589503853, 73.73012300482546],
          },
        },
        tpo: {
          id: 22408,
    ...
    },
    {
      ...
      plantProject: {
        ...
        geoJson: {
          ...
          geometry: {
            type: 'Point',
            coordinates: [12.535627680409823, 76.57783098852799],
          },
        },
        tpo: {
          id: 22408,
    ...
    },
    {
      ...
      plantProject: {
        ...
        geoJson: {
          ...
          geometry: {
            type: 'Point',
            coordinates: [39.21722484220771, 93.10126889104367],
          },
        },
        tpo: {
          id: 22408,
      ...
      bouquetContributions: [
        {
          ...
          plantProject: {
            ...
            geoJson: {
              ...
              geometry: {
                type: 'Point',
                coordinates: [39.21722484220771, -6.918264795460748],
              },
            },
            tpo: {
              id: 22408,
        ...
        },
        {
          ...
          plantProject: {
            ...
            geoJson: {
              ...
              geometry: {
                type: 'Point',
                coordinates: [61.51344331267355, 9.25361059849075],
              },
            },
            tpo: {
              id: 112999,
  ...
  const _cloneContribution = [
    {
      ...
      geometry: {
        type: 'Point',
        coordinates: [28.42063658644849, 79.45965234102273],
      },
    },
    {
      type: 'Feature',
      ...
      geometry: {
        type: 'Point',
        coordinates: [20.625620619347146, 50.47448234955583],
      },
    },
    {
      type: 'Feature',
      properties: {
        ...
        quantity: 3,
        donationIssueDate: null,
        contributionType: 'register',
        plantProject: {
          guid: 'proj_s0Dt9sivTAptMOfJSleb',
          name: 'Reforestation of our Forests in Germany',
          image: '62f3bac270a37408634575.jpg',
          countryCode: 'DE',
          unit: 'tree',
      ...
      geometry: {
        type: 'Point',
        coordinates: [20.625620619347146, 48.47448234955583],
      },
    },
    // {
    //   type: 'Feature',
    ...
    //   geometry: {
    //     type: 'Point',
    //     coordinates: [28.15594294566528, 82.34033062705153],
    //   },
    // },
    // {
    //   type: 'Feature',
    ...
    //   geometry: {
    //     type: 'Point',
    //     coordinates: [29.15594294566528, 82.34033062705153],
    //   },
    // },
    // {
    //   type: 'Feature',
    ...
    //     contributionType: 'donation',
    //     plantProject: {
    //       guid: 'proj_s0Dt9sivTkYLAptM2OfJSeb',
    //       name: 'it is an conservation project',
    //       image: '62f3bac270a37408634575.jpg',
    //       countryCode: 'DE',
    //       unit: 'm2',
    ...
    //   geometry: {
    //     type: 'Point',
    //     coordinates: [52.28715224858672, 82.69232875509609],
    //   },
    // },
  ];
  ...
  return ready ? (
    ...
    >
      <MyTreesMap geoJson={_cloneContribution} />
      {/* <MyTreesMap
