...
import type {PendingDonationView} from "../../../types/donation-receipts";

interface DonationListProps {
    donations: PendingDonationView[] | null;
}

const PendingDonationsList: React.FC<DonationListProps> = ({donations}) => {
...
export default PendingDonationsList;
