  ...
  return (
    ...
    >
      ...
      <div className={styles.modal}>
          ...
          <div className={styles.settingsItem}> Edit Profile </div>
          ...
          <div className={styles.settingsItem}><b> Logout </b></div>
          <div className={styles.settingsItem} onClick={handleSettingsModalClose}><p className={styles.cancelText}> Cancel</p> </div>
        </div>
      </Fade>
    </Modal>
  );
