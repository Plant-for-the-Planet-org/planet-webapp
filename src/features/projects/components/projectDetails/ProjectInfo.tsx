...
function ProjectInfo({ project }: Props): ReactElement {
  ...
  const siteOwners = [
    ...
    {
      id: 2,
      title: t('manageProjects:siteOwnerPublic'),
      value: 'public-property',
    },
    {
      id: 3,
      title: t('manageProjects:siteOwnerSmallHolding'),
      value: 'smallholding',
    },
    {
      id: 4,
      title: t('manageProjects:siteOwnerCommunal'),
      value: 'communal-land',
    },
    {
      id: 5,
      title: t('manageProjects:siteOwnerOwned'),
    ...
    <div>
      <div className={styles.projectMoreInfoHalfContainer}>
        ...
        {project.employeesCount && (
          <div className={styles.projectMoreInfoHalf}>
            ...
            <div className={styles.infoText}>{project.employeesCount}</div>
          </div>
        )}
              ...
              {project.plantingSeasons.map((season: any, index: any) => {
                return (
                  <>
                    ...
                    {index === project.plantingSeasons.length - 2
                      ? ' and '
                      : index === project.plantingSeasons.length - 1
                      ? '.'
                      : ', '}
                  </>
                );
      ...
      {project.degradationCause && (
        <div className={styles.projectMoreInfo}>
          ...
          <div className={styles.infoText}>{project.degradationCause}</div>
        </div>
      )}
      ...
      {project.motivation && (
        <div className={styles.projectMoreInfo}>
          ...
          <div className={styles.infoText}>{project.motivation}</div>
        </div>
      )}
      ...
      {project.longTermPlan && (
        <div className={styles.projectMoreInfo}>
          ...
          <div className={styles.infoText}>{project.longTermPlan}</div>
        </div>
      )}
