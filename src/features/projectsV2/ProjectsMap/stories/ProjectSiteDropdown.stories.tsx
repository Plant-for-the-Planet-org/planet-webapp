...
const options: ProjectSiteFeature[] = [
  {
    ...
    properties: {
      ...
      name: 'A-very-long-site-name-to-test-UI-behavior-in-case-of-overflows-or-wrapping',
      description: null,
  ...
  },
  {
    ...
    properties: {
      ...
      name: 'site 2021',
      description:
        'Friends of Earth Environment Preservation and Care is a nonprofit and registered organization. All members, youth and children are committed in environmental conservation. The core value of the organization is voluntarism that has made us go thousands miles. It has partnered with 56 community groups in Western Kenya in the billion tree campaign. It is to plant more trees to fight climate and make people live in a world free of poverty. Friends of Earth Environment Preservation and Care is not tax deductible and cannot issue donation receipts!',
  ...
  },
  {
    ...
    properties: {
      ...
      name: 'Friends of Earth Environment Preservation and Care',
      description:
        'Friends of Earth Environment Preservation and Care is a nonprofit and registered organization. All members, youth and children are committed in environmental conservation. The core value of the organization is voluntarism that has made us go thousands miles. It has partnered with 56 community groups in Western Kenya in the billion tree campaign. It is to plant more trees to fight climate and make people live in a world free of poverty.\r\n\r\nFriends of Earth Environment Preservation and Care is not tax deductible and cannot issue donation receipts!',
