...
const LayerInfoPopup = ({ closePopup, selectedLayer }: LayerInfoPopupProps) => {
  return (
    <div className={styles.layerInfoPopup}>
      ...
      <div className={styles.popupContent}>
        ...
        <p>
          ...
          decrease in biomass at the beginning of the restoration work. This is
          not necessarily a bad thing.
        </p>
        <p>
          For instance, when converting a degraded cattle ranch back to forest,
          a project might initially have to cut tall grass in order to plant
          small tree seedlings. It will take a few years before the biomass of
          the young trees exceeds the biomass of the removed grass.
        </p>{' '}
        <h3>Source</h3>{' '}
        <p>
          The change is biomass is calculated by a Plant-for-the-Planet analysis
