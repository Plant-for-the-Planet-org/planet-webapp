      ...
      <div className={`${gridStyles.fluidContainer} ${styles.contentSection}`}>
        ...
        <div className={`${gridStyles.gridRow} ${gridStyles.justifyContentCenter} ${gridStyles.mb65100}`}>
          <div className={`${gridStyles.colMd7} ${gridStyles.col12} ${gridStyles.orderSm1} ${gridStyles.orderMd0} ${styles.justifyContentCenter}`}>
            ...
            <p>Salesforce is committed to doing all we can to limit global warming to 1.5° Celsius. We are rapidly accelerating our sustainability program and integrating climate action into the core of our business to ultimately deliver on this shared, planetary goal of a more sustainable and equitable future.</p>
            <p>In January 2020, as a founding partner of <a href="https://www.1t.org/" target="_blank" rel="noreferrer noopener">1t.org</a>, Salesforce announced our own goal to support and mobilize the conservation, restoration, and growth of 100 million trees by the end of 2030.</p>
            <p>We know we’ll have to refine our programs and methodology over time by sharing with and learning from others, but we know it must be done in a <a href="https://www.togetherwithnature.com/" target="_blank" rel="noreferrer noopener">socially and ecologically responsible way</a>.  This includes meaningfully engaging with indigenous people and local communities on this journey. Restoration of our ecosystems is only sustainable when local communities reap social, economic, and ecological benefits.</p>
          </div>
