...
3. **Screen reader support:** A11Y-004 (completed), A11Y-008 (completed), A11Y-010, A11Y-012, A11Y-013, A11Y-014, A11Y-024, A11Y-026, A11Y-030, A11Y-034.
...
> "(completed)" means the fix is merged into `develop`. 14 of 35 findings are done: A11Y-001, 002, 003, 004, 005, 006, 008, 016, 018, 019, 020, 021, 028, 035.
>
