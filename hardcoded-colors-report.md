...
----------------------------------------------------
- Line 20: white in "<rect width="21.8" height="19.15" fill="white" />"
...
----------------------------------------------------------------------
- Line 35: #fff in "fill="#fff""
- Line 18: white in "fill="white""

File: public/assets/images/icons/myForestMapIcons/RegisteredTreePopupIcon.tsx
-----------------------------------------------------------------------------
- Line 13: white in "<circle cx="12" cy="11.5" r="11.5" fill="white" />"
...
File: public/assets/images/icons/projectV2/AverageMarkerIcon.tsx
----------------------------------------------------------------
- Line 18: #219653 in "stroke="#219653""
- Line 14: white in "fill="white""

File: public/assets/images/icons/projectV2/BiomassChangeIcon.tsx
----------------------------------------------------------------
- Line 13: #333333 in "fill="#333333""
- Line 30: white in "<rect width="8" height="12" fill="white" transform="translate(3 1)" />"
...
---------------------------------------------------------
- Line 20: white in "<rect width="16" height="16" fill="white" />"

File: public/assets/images/icons/projectV2/SiteIcon.tsx
-------------------------------------------------------
- Line 16: white in "fill="white""

File: public/assets/images/icons/projectV2/SlideNextButtonIcon.tsx
------------------------------------------------------------------
- Line 12: white in "stroke="white""

File: public/assets/images/icons/projectV2/SlidePrevButtonIcon.tsx
------------------------------------------------------------------
- Line 11: white in "stroke="white""

File: public/assets/images/icons/projectV2/TreeCoverIcon.tsx
------------------------------------------------------------
- Line 13: #333333 in "fill="#333333""
- Line 21: white in "fill="white""
...
- Line 272: rgba(0, 0, 0, 0.2) in "box-shadow: 4px 8px 16px rgba(0, 0, 0, 0.2);"
...
------------------------------------------------------------------
- Line 80: rgba(150, 150, 150, 0.2) in "box-shadow: rgba(150, 150, 150, 0.2) 0px 0px 4px;"
...
- Line 230: rgba(0, 0, 0, 0.2) in "box-shadow: 4px 8px 16px rgba(0, 0, 0, 0.2);"

File: src/features/projectsV2/ProjectSnippet/styles/ProjectSnippet.module.scss
------------------------------------------------------------------------------
- Line 7: rgba(0, 0, 0, 0.1) in "box-shadow: 4px 8px 16px 0px rgba(0, 0, 0, 0.1);"
- Line 55: rgba(0, 0, 0, 1) in "rgba(0, 0, 0, 1),"
- Line 56: rgba(0, 0, 0, 0.4) in "rgba(0, 0, 0, 0.4),"
- Line 57: rgba(0, 0, 0, 0) in "rgba(0, 0, 0, 0),"

File: src/features/projectsV2/ProjectsMap/FirePopup/index.tsx
-------------------------------------------------------------
- Line 160: #828282 in "<InfoIconPopup width={9} height={9} color={'#828282'}>"
- Line 185: #4F4F4F in "<RightArrowIcon width={5} color={'#4F4F4F'} />"

File: src/features/projectsV2/ProjectsMap/MapFeatureExplorer/CustomButton.tsx
-----------------------------------------------------------------------------
- Line 18: rgba(0, 0, 0, 0.12) in "boxShadow: '0px 6px 10px rgba(0, 0, 0, 0.12)',"
...
File: src/features/projectsV2/ProjectsMap/SiteMapLayerControls/LayerInfoPopup.tsx
---------------------------------------------------------------------------------
- Line 27: green in "green. Areas where it has decreased substantially appear in red. No"
- Line 27: red in "green. Areas where it has decreased substantially appear in red. No"
...
--------------------------------------------------------------
- Line 342: #fff in "'line-color': '#fff',"
...
----------------------------------------------------------------------------------
- Line 14: green in "backgroundColor: 'green',"

File: src/features/user/Account/AccountHistory.module.scss
----------------------------------------------------------
- Line 499: rgba(0, 0, 0, 0.4) in "background-color: rgba(0, 0, 0, 0.4);"

File: src/features/user/Account/CancelModal.tsx
-----------------------------------------------
- Line 114: #4d5153 in "<Close color={'#4d5153'} />"

File: src/features/user/Account/EditModal.tsx
---------------------------------------------
- Line 156: #4d5153 in "<Close color={'#4d5153'} />"

File: src/features/user/Account/PauseModal.tsx
----------------------------------------------
- Line 124: #4d5153 in "<Close color={'#4d5153'} />"
...
------------------------------------------------------------------
- Line 318: #ECB641 in "color={image.isDefault ? '#ECB641' : '#2f3336'}"
- Line 318: #2f3336 in "color={image.isDefault ? '#ECB641' : '#2f3336'}"

File: src/features/user/ManageProjects/components/ProjectSites.tsx
------------------------------------------------------------------
- Line 545: #000 in "<EditIcon color={'#000'} />"
- Line 569: #fff in "'fill-color': '#fff',"
- Line 573: #68B030 in "'line-color': '#68B030',"

File: src/features/user/ManageProjects/components/ProjectSpending.tsx
---------------------------------------------------------------------
- Line 195: #000 in "<PencilIcon color={"#000"} />"
...
---------------------------------------------------------------------------
- Line 273: rgba(0, 0, 0, 1) in "rgba(0, 0, 0, 1),"
- Line 274: rgba(0, 0, 0, 0.4) in "rgba(0, 0, 0, 0.4),"
- Line 275: rgba(0, 0, 0, 0) in "rgba(0, 0, 0, 0),"

File: src/features/user/RegisterTrees/RegisterModal.module.scss
---------------------------------------------------------------
- Line 78: rgba(0, 0, 0, 0.16) in "box-shadow: -2px 2px 8px 0px rgba(0, 0, 0, 0.16);"
- Line 173: rgba(0, 0, 0, 0.5) in "background: rgba(0, 0, 0, 0.5);"
...
------------------------------------------------------------
- Line 42: rgba(0, 0, 0, 0.25) in "box-shadow: 0px -2px 4px 0px rgba(0, 0, 0, 0.25);"
- Line 197: rgba(47, 51, 54, 0) in "rgba(47, 51, 54, 0) 60%,"
- Line 198: rgba(47, 51, 54, 0.22) in "rgba(47, 51, 54, 0.22) 76%,"
- Line 199: rgba(47, 51, 54, 0.74) in "rgba(47, 51, 54, 0.74)"
- Line 219: rgba(60, 60, 60, 1) in "box-shadow: 0 7px 12px -6px rgba(60, 60, 60, 1);"
...
---------------------------
- Line 397: #f3f3f3 in "border: 2px solid #f3f3f3;"
- Line 554: #828282 in "color: #828282;"
- Line 309: rgba(0, 0, 0, 0.6) in "background: rgba(0, 0, 0, 0.6);"

File: src/utils/constants/intervention.ts
-----------------------------------------
- Line 29: #007A49 in "* where interventionPairs are 'intervention-type': 'color' pairs (e.g., 'single-tree': '#007A49')"

File: src/utils/mapsV2/mapSettings.config.ts
--------------------------------------------
- Line 105: #27AE60 in "color: '#27AE60',"
- Line 122: #FFF59A in "'linear-gradient(90deg, #FFF59A 0%, #FEFB27 48%, #36670C 100%)',"
- Line 122: #FEFB27 in "'linear-gradient(90deg, #FFF59A 0%, #FEFB27 48%, #36670C 100%)',"
- Line 122: #36670C in "'linear-gradient(90deg, #FFF59A 0%, #FEFB27 48%, #36670C 100%)',"
- Line 155: #EB5757 in "color: '#EB5757',"
- Line 171: #2F80ED in "color: '#2F80ED',"
- Line 207: #6C8DFF in "'linear-gradient(90deg, #FFF59A 0%, #FEFB27 48%, #6C8DFF 100%)',"
- Line 232: #FE4242 in "'linear-gradient(90deg, #FE4242 0%, #F3F7C7 45.5%, #6C8DFF 100%)',"
- Line 232: #F3F7C7 in "'linear-gradient(90deg, #FE4242 0%, #F3F7C7 45.5%, #6C8DFF 100%)',"
- Line 256: #361600 in "'linear-gradient(90deg, #FFF59A 0%, #FEFB27 48%, #361600 100%)',"
- Line 281: #FEF27B in "'linear-gradient(90deg, #FEF27B 0%, #F9A817 48%, #E03301 100%)',"
- Line 281: #F9A817 in "'linear-gradient(90deg, #FEF27B 0%, #F9A817 48%, #E03301 100%)',"
- Line 281: #E03301 in "'linear-gradient(90deg, #FEF27B 0%, #F9A817 48%, #E03301 100%)',"
- Line 309: #F3F3F3 in "'linear-gradient(90deg, #F3F3F3 0%, #CEDFBC 48%, #1F3000 100%)',"
- Line 309: #CEDFBC in "'linear-gradient(90deg, #F3F3F3 0%, #CEDFBC 48%, #1F3000 100%)',"
- Line 309: #1F3000 in "'linear-gradient(90deg, #F3F3F3 0%, #CEDFBC 48%, #1F3000 100%)',"
- Line 333: #FFFFFF in "gradient: 'linear-gradient(90deg, #FFFFFF 0%, #0A529E 100%)',"
- Line 333: #0A529E in "gradient: 'linear-gradient(90deg, #FFFFFF 0%, #0A529E 100%)',"
- Line 356: #A71015 in "gradient: 'linear-gradient(90deg, #FFFFFF 0%, #A71015 100%)',"
- Line 379: #0E903E in "gradient: 'linear-gradient(90deg, #FFFFFF 0%, #0E903E 100%)',"
- Line 401: #F2C94C in "{ categoryKey: 'veryLow', color: '#F2C94C' },"
- Line 402: #F2994A in "{ categoryKey: 'low', color: '#F2994A' },"
- Line 403: #FA7902 in "{ categoryKey: 'medium', color: '#FA7902' },"
...
Total files with hardcoded colors: 263
Total hardcoded color instances: 741
Unique colors (normalized): 206

## UNIQUE COLORS WITH EQUIVALENT REPRESENTATIONS

- #000063
- #0065CA
- #007A49, #007a49, rgba(0, 122, 73, 0.5), rgba(0, 122, 73, 1)
- #007b49
- #009fe3
- #0176D3, #0176d3
- #017a49
...
- #ffd991
- #FFDD55
- #FFF, #FFFFFF, #fff, #ffffff, rgba(255, 255, 255, 0.3), rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.7125), rgba(255, 255, 255, 0.9), white
- #FFF59A
- #000, #000000, black, rgb(0, 0, 0, 0.2), rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.05), rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.12), rgba(0, 0, 0, 0.16), rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.29), rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.35), rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 1)
- Blue, blue
- gray, grey
- green
- rgb(186, 238, 137)
