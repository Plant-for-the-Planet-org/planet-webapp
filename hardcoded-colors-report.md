...
File: public/assets/images/footer/UNEPLogo.tsx
----------------------------------------------
...
File: public/assets/images/icons/DeleteIcon.tsx
-----------------------------------------------
- Line 7: #333 in "color = '#333',"
...
File: public/assets/images/icons/MyContributionsIcon.tsx
--------------------------------------------------------
...
File: public/assets/images/icons/ProgressBarIcons.tsx
-----------------------------------------------------
...
File: public/assets/images/icons/Sidebar/TreeMapperIcon.tsx
-----------------------------------------------------------
- Line 13: #130F26 in "fill="#130F26""
...
File: public/assets/images/icons/VerifyEmail.tsx
------------------------------------------------
...
File: public/assets/images/icons/headerIcons/Me.tsx
---------------------------------------------------
...
File: public/assets/images/icons/project/ManagedRegeneration.tsx
----------------------------------------------------------------
- Line 8: white in "fill="white""
...
File: public/assets/images/icons/projectV2/DownloadIcon.tsx
-----------------------------------------------------------
...
File: public/assets/images/icons/projectV2/PlayButtonIcon.tsx
-------------------------------------------------------------
- Line 15: white in "fill="white""
...
File: src/features/common/Layout/CustomModal/CustomModal.module.scss
--------------------------------------------------------------------
...
File: src/features/projects/components/projectDetails/ImageSlider.tsx
---------------------------------------------------------------------
...
File: src/features/projects/styles/ProjectsMap.module.scss
----------------------------------------------------------
...
File: src/features/projectsV2/ProjectDetails/styles/AboutProject.module.scss
----------------------------------------------------------------------------
...
File: src/features/projectsV2/ProjectsMap/FirePopup/FirePopup.module.scss
-------------------------------------------------------------------------
- Line 3: #fff in "$backgroundColor: #fff;"
- Line 5: #e86f56 in "$dangerColorNew: #e86f56;"
- Line 56: #333 in "color: #333; //to be replaced"
- Line 65: #4f4f4f in "color: #4f4f4f; //to be replaced"
- Line 71: #828282 in "color: #828282; //to be replaced"
- Line 6: rgba(249, 220, 214) in "$dangerBackgroundColor: rgba(249, 220, 214);"
- Line 46: rgba(232, 111, 86, 0.2) in "background: rgba(232, 111, 86, 0.2); //to be replaced"

File: src/features/projectsV2/ProjectsMap/FirePopup/index.tsx
-------------------------------------------------------------
- Line 157: #828282 in "<InfoIconPopup width={9} height={9} color={'#828282'}>"
- Line 182: #4F4F4F in "<RightArrowIcon width={5} color={'#4F4F4F'} />"

File: src/features/projectsV2/ProjectsMap/InterventionDropDown/InterventionList.module.scss
-------------------------------------------------------------------------------------------
- Line 53: #333 in "color: #333; //to be replaced"
- Line 99: rgba(51, 51, 51, 1) in "color: rgba(51, 51, 51, 1);"

File: src/features/projectsV2/ProjectsMap/MapFeatureExplorer/CustomButton.tsx
-----------------------------------------------------------------------------
- Line 17: rgba(0, 0, 0, 0.12) in "boxShadow: '0px 6px 10px rgba(0, 0, 0, 0.12)',"
- Line 13: black in "color: 'black',"

File: src/features/projectsV2/ProjectsMap/MapFeatureExplorer/MapFeatureExplorer.module.scss
-------------------------------------------------------------------------------------------
- Line 44: #fff in "background-color: #fff;"
- Line 47: rgba(0, 0, 0, 0.12) in "box-shadow: 0px 6px 10px rgba(0, 0, 0, 0.12);"
- Line 103: rgba(0, 122, 73, 0.05) in "background: rgba(0, 122, 73, 0.05);"
- Line 156: rgba(130, 130, 130, 1) in "color: rgba(130, 130, 130, 1);"
...
----------------------------------------------------------------------------------------
- Line 13: rgba(217, 217, 217, 1) in "border: '1px solid rgba(217, 217, 217, 1)',"

File: src/features/projectsV2/ProjectsMap/ProjectMarkers/ProjectMarkers.module.scss
-----------------------------------------------------------------------------------
- Line 10: rgba(0, 0, 0, 0.25) in "filter: drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25));"

File: src/features/projectsV2/ProjectsMap/ProjectSiteDropDown/SiteDropdown.module.scss
--------------------------------------------------------------------------------------
- Line 45: #333 in "color: #333; //to be replaced"
- Line 83: rgba(51, 51, 51, 1) in "color: rgba(51, 51, 51, 1);"

File: src/features/projectsV2/ProjectsMap/ProjectSiteDropDown/index.tsx
-----------------------------------------------------------------------
- Line 99: #333 in "<SiteIcon width={27} color={'#333'} />"
...
File: src/features/user/ManageProjects/ProjectsContainer.module.scss
--------------------------------------------------------------------
...
File: src/features/user/Profile/ContributionsMap/Common/common.module.scss
--------------------------------------------------------------------------
...
File: src/features/user/Profile/ProfileCard/ProfileCard.module.scss
-------------------------------------------------------------------
...
----------------------------------------------------------------------------
- Line 4: #94f0f9 in "background-color: #94f0f9;"
- Line 37: #f3f3f3 in "border: 2px solid #f3f3f3;"
...
-----------------------------------------------------------------------------------
- Line 4: rgba(0,0,0,0.35) in "box-shadow: 0px 0px 20px -10px rgba(0,0,0,0.35);"

File: src/features/user/TreeMapper/Analytics/components/Counter/components/CounterItem/index.module.scss
--------------------------------------------------------------------------------------------------------
- Line 19: #4f4f4f in "border-right: 1px #4f4f4f solid;"

File: src/features/user/TreeMapper/Analytics/components/Counter/index.module.scss
---------------------------------------------------------------------------------
- Line 7: rgba(0,0,0,0.35) in "box-shadow: 0px 0px 20px -10px rgba(0,0,0,0.35);"

File: src/features/user/TreeMapper/Analytics/components/Export/index.tsx
------------------------------------------------------------------------
- Line 31: #fff in "color: '#fff',"
...
- Line 146: #333333 in "fill="#333333""
- Line 170: #007A49 in "fill="#007A49""
- Line 204: #4F4F4F in "fill="#4F4F4F""
- Line 82: white in "fill="white""

File: src/features/user/TreeMapper/Analytics/components/Map/components/TreeMapperIcon.tsx
-----------------------------------------------------------------------------------------
- Line 14: #89B53A in "stroke="#89B53A""
- Line 13: white in "fill="white""

File: src/features/user/TreeMapper/Analytics/components/Map/index.module.scss
-----------------------------------------------------------------------------
- Line 59: #fff in "background-color: #fff;"
- Line 139: white in "white-space: nowrap;"

File: src/features/user/TreeMapper/Analytics/components/Map/index.tsx
---------------------------------------------------------------------
...
- Line 241: rgba(255, 255, 255, 0.8) in "background: rgba(255, 255, 255, 0.8) !important;"
- Line 305: rgba(0, 0, 0, 0.16) in "box-shadow: -2px 2px 8px 0px rgba(0, 0, 0, 0.16);"
- Line 396: rgba(0, 122, 73, 0.5) in "background-color: rgba(0, 122, 73, 0.5);"
- Line 401: rgba(0, 122, 73, 1) in "background-color: rgba(0, 122, 73, 1);"
- Line 267: yellow in "// background-color: yellow;"

File: src/features/user/TreeMapper/components/Map.tsx
-----------------------------------------------------
- Line 272: #ffffff in "'fill-color': satellite ? '#ffffff' : '#007A49',"
- Line 272: #007A49 in "'fill-color': satellite ? '#ffffff' : '#007A49',"

File: src/features/user/Widget/EmbedModal.module.scss
-----------------------------------------------------
- Line 102: #f3f3f3 in "border: 2px solid #f3f3f3;"

File: src/tenants/common/LeaderBoard/LeaderBoard.module.scss
------------------------------------------------------------
- Line 51: #dddbda in "border-bottom: 1px solid #dddbda;"
- Line 112: #706e6b in "color: #706e6b;"

File: src/tenants/planet/LeaderBoard/components/LeaderBoard.module.scss
-----------------------------------------------------------------------
- Line 58: #dddbda in "border-bottom: 1px solid #dddbda;"
- Line 133: #706e6b in "color: #706e6b;"

File: src/tenants/planet/LeaderBoard/components/Stats.tsx
---------------------------------------------------------
- Line 53: #000 in "<InfoIcon color="#000" />"

File: src/tenants/planet/LeaderBoard/components/StatsInfoModal.tsx
------------------------------------------------------------------
- Line 78: #d5d5d5 in "<CancelIcon color="#d5d5d5" />"

File: src/tenants/salesforce/Home/components/GrowingImpact.tsx
--------------------------------------------------------------
- Line 45: #024D4C in "bgColor: '#024D4C',"
- Line 54: #396547 in "bgColor: '#396547',"
- Line 63: #0B827C in "bgColor: '#0B827C',"
- Line 71: #1C3326 in "bgColor: '#1C3326',"

File: src/tenants/salesforce/Home/components/Timeline.tsx
---------------------------------------------------------
- Line 60: blue in "copy: 'Led by Friends of Ocean Action in collaboration with <a href="https://www.1t.org/" target="_blank" rel="noreferrer">1t.org</a>, this working group will build the capacity of demand-side stakeholders to tap into the growing blue carbon market. Salesforce joins to champion the effort and learn from the work.',"

File: src/tenants/salesforce/Home/index.tsx
-------------------------------------------
- Line 31: white in "<main style={{ backgroundColor: 'white', paddingBottom: '60px' }}>"

File: src/tenants/salesforce/Home/styles/ClimateAction.module.scss
------------------------------------------------------------------
- Line 32: #032d60 in "color: #032d60;"
- Line 48: #181818 in "color: #181818;"
- Line 54: #1a1a1a in "color: #1a1a1a;"
- Line 74: #939393 in "color: #939393;"
- Line 104: #215ca0 in "background: #215ca0;"
- Line 112: #ffffff in "color: #ffffff;"

File: src/tenants/salesforce/Home/styles/ContentSection.module.scss
-------------------------------------------------------------------
- Line 40: #ffffff in "// color: #ffffff;"
- Line 41: #032d60 in "color: #032d60;"
- Line 76: #0b5cab in "color: #0b5cab;"
- Line 128: #080707 in "color: #080707;"

File: src/tenants/salesforce/Home/styles/GrowingImpact.module.scss
------------------------------------------------------------------
- Line 37: #032d60 in "color: #032d60;"
- Line 60: #181818 in "color: #181818;"
- Line 66: #1a1a1a in "color: #1a1a1a;"
- Line 93: #ffffff in "color: #ffffff;"
- Line 144: #939393 in "color: #939393;"
- Line 184: #215ca0 in "background: #215ca0;"

File: src/tenants/salesforce/Home/styles/Landing.module.scss
------------------------------------------------------------
- Line 52: #032d60 in "color: #032d60;"
- Line 99: #0176d3 in "background: #0176d3;"
- Line 107: #ffffff in "color: #ffffff;"

File: src/tenants/salesforce/Home/styles/LeaderBoardSection.module.scss
-----------------------------------------------------------------------
- Line 89: #080707 in "color: #080707;"
- Line 100: #032d60 in "color: #032d60;"
- Line 110: #f5f2f2 in "background-color: #f5f2f2;"
- Line 163: #dddbda in "border-bottom: 1px solid #dddbda;"
- Line 175: #181818 in "color: #181818;"
- Line 196: #706e6b in "color: #706e6b;"
- Line 37: white in "background-color: white;"

File: src/tenants/salesforce/Home/styles/SeaOfTrees.module.scss
---------------------------------------------------------------
- Line 20: #0176d3 in "background: #0176d3;"
- Line 28: #ffffff in "color: #ffffff;"
- Line 35: #0b827c in "background-color: #0b827c;"
- Line 50: #032d60 in "color: #032d60;"
- Line 85: #0b5cab in "color: #0b5cab;"
- Line 141: #080707 in "color: #080707;"

File: src/tenants/salesforce/Home/styles/Social.module.scss
-----------------------------------------------------------
- Line 15: #032d60 in "color: #032d60;"
- Line 32: #181818 in "color: #181818;"
- Line 37: #1a1a1a in "color: #1a1a1a;"
- Line 47: #215ca0 in "background: #215ca0;"
- Line 55: #ffffff in "color: #ffffff;"

File: src/tenants/salesforce/Home/styles/Timeline.module.scss
-------------------------------------------------------------
- Line 19: #032d60 in "color: #032d60;"
- Line 51: #181818 in "color: #181818;"
- Line 61: #0b5cab in "color: #0b5cab;"
- Line 106: #0176d3 in "color: #0176d3;"
- Line 173: #e5e5e5 in "background-color: #e5e5e5;"
- Line 226: white in "background-color: white;"

File: src/tenants/salesforce/Mangroves/components/AdditionalContent.tsx
-----------------------------------------------------------------------
- Line 16: Blue in "alt="Blue Ventures Photo - Madagascar - Ambanja mangrove seedling. Credit Louise Jasper 2018""

File: src/tenants/salesforce/Mangroves/components/BlueCarbon.tsx
----------------------------------------------------------------
- Line 2: Blue in "import styles from './../styles/BlueCarbon.module.scss';"
- Line 2: blue in "import styles from './../styles/BlueCarbon.module.scss';"

File: src/tenants/salesforce/Mangroves/components/ContentSection.tsx
--------------------------------------------------------------------
- Line 79: white in "href="https://www.salesforce.com/content/dam/web/en_us/www/documents/white-papers/nature-positive-strategy.pdf""
- Line 119: Blue in "href="https://blueventures.org/what-we-do/""

File: src/tenants/salesforce/Mangroves/index.tsx
------------------------------------------------
- Line 23: white in "<main style={{ backgroundColor: 'white', paddingBottom: '60px' }}>"

File: src/tenants/salesforce/Mangroves/styles/AdditionalContent.module.scss
---------------------------------------------------------------------------
- Line 23: #032d60 in "color: #032d60;"
- Line 46: #181818 in "color: #181818;"
- Line 52: #1a1a1a in "color: #1a1a1a;"
- Line 56: #0b5cab in "color: #0b5cab;"

File: src/tenants/salesforce/Mangroves/styles/BlueCarbon.module.scss
--------------------------------------------------------------------
- Line 13: #0176d3 in "background: #0176d3;"
- Line 21: #ffffff in "color: #ffffff;"
- Line 27: #0b827c in "background-color: #0b827c;"
- Line 43: #032d60 in "color: #032d60;"
- Line 79: #0b5cab in "color: #0b5cab;"
- Line 109: rgba(255, 255, 255, 0.7125) in "rgba(255, 255, 255, 0.7125) 13.14%,"
- Line 110: rgba(255, 255, 255, 0.9) in "rgba(255, 255, 255, 0.9) 65.48%"
- Line 116: rgba(255, 255, 255, 0.3) in "rgba(255, 255, 255, 0.3) 15%,"
- Line 117: rgba(255, 255, 255, 0.7) in "rgba(255, 255, 255, 0.7) 30%,"

File: src/tenants/salesforce/Mangroves/styles/ContentSection.module.scss
------------------------------------------------------------------------
- Line 22: #032d60 in "color: #032d60;"
- Line 61: #0b5cab in "color: #0b5cab;"
- Line 124: #fff in "background-color: #fff;"
- Line 188: #ffffff in "background-color: #ffffff;"
- Line 201: #0176d3 in "background: #0176d3;"
- Line 164: rgba(255, 255, 255, 0.7125) in "rgba(255, 255, 255, 0.7125) 13.14%,"
- Line 165: rgba(255, 255, 255, 0.9) in "rgba(255, 255, 255, 0.9) 65.48%"

File: src/tenants/salesforce/Mangroves/styles/Landing.module.scss
-----------------------------------------------------------------
- Line 68: #fff in "color: #fff;"
- Line 113: #0176d3 in "background: #0176d3;"
- Line 121: #ffffff in "color: #ffffff;"
- Line 34: rgb(0, 0, 0, 0.2) in "background-color: rgb(0, 0, 0, 0.2);"

File: src/tenants/salesforce/Mangroves/styles/ProjectGrid.module.scss
---------------------------------------------------------------------
- Line 13: #0176d3 in "background: #0176d3;"
- Line 21: #ffffff in "color: #ffffff;"
- Line 47: #032d60 in "color: #032d60;"
...
---------------------------------------------------------
- Line 30: white in "<main style={{ backgroundColor: 'white', paddingBottom: '60px' }}>"

File: src/tenants/salesforce/OceanforceCampaign/styles/AdditionalContent.module.scss
------------------------------------------------------------------------------------
- Line 23: #032d60 in "color: #032d60;"
- Line 46: #181818 in "color: #181818;"
- Line 52: #1a1a1a in "color: #1a1a1a;"
...
File: src/tenants/salesforce/OceanforceCampaign/styles/ContentSection.module.scss
---------------------------------------------------------------------------------
- Line 22: #032d60 in "color: #032d60;"
- Line 55: #0b5cab in "color: #0b5cab;"
- Line 107: #ffffff in "color: #ffffff;"
- Line 112: #0176d3 in "background: #0176d3;"

File: src/tenants/salesforce/OceanforceCampaign/styles/Landing.module.scss
--------------------------------------------------------------------------
- Line 68: #fff in "color: #fff;"
- Line 113: #0176d3 in "background: #0176d3;"
- Line 121: #ffffff in "color: #ffffff;"
...
File: src/tenants/salesforce/OceanforceCampaign/styles/LeaderBoardSection.module.scss
-------------------------------------------------------------------------------------
- Line 58: #080707 in "color: #080707;"
- Line 69: #032d60 in "color: #032d60;"
- Line 79: #f5f2f2 in "background-color: #f5f2f2;"
- Line 132: #dddbda in "border-bottom: 1px solid #dddbda;"
- Line 144: #181818 in "color: #181818;"
- Line 165: #706e6b in "color: #706e6b;"
- Line 36: white in "background-color: white;"

File: src/tenants/salesforce/OceanforceCampaign/styles/ParticipationSection.module.scss
---------------------------------------------------------------------------------------
- Line 18: #0176d3 in "background: #0176d3;"
- Line 26: #ffffff in "color: #ffffff;"
- Line 33: #0b827c in "background-color: #0b827c;"
- Line 50: #032d60 in "color: #032d60;"
- Line 102: #0b5cab in "color: #0b5cab;"
- Line 166: #080707 in "color: #080707;"
...
------------------------------------------------------
- Line 32: white in "<main style={{ backgroundColor: 'white', paddingBottom: '60px' }}>"

File: src/tenants/salesforce/VTOCampaign2023/styles/AdditionalInfo.module.scss
------------------------------------------------------------------------------
- Line 23: #032d60 in "color: #032d60;"
- Line 46: #181818 in "color: #181818;"
- Line 52: #1a1a1a in "color: #1a1a1a;"
...
File: src/tenants/salesforce/VTOCampaign2023/styles/ContentSection.module.scss
------------------------------------------------------------------------------
- Line 22: #032d60 in "color: #032d60;"
- Line 55: #0b5cab in "color: #0b5cab;"

File: src/tenants/salesforce/VTOCampaign2023/styles/Landing.module.scss
-----------------------------------------------------------------------
- Line 50: #032d60 in "color: #032d60;"
- Line 95: #0176d3 in "background: #0176d3;"
- Line 103: #ffffff in "color: #ffffff;"

File: src/tenants/salesforce/VTOCampaign2023/styles/LeaderBoardSection.module.scss
----------------------------------------------------------------------------------
- Line 58: #080707 in "color: #080707;"
- Line 69: #032d60 in "color: #032d60;"
- Line 79: #f5f2f2 in "background-color: #f5f2f2;"
...
File: src/tenants/salesforce/VTOCampaign2023/styles/ProjectGrid.module.scss
---------------------------------------------------------------------------
- Line 13: #0176d3 in "background: #0176d3;"
- Line 21: #ffffff in "color: #ffffff;"
- Line 45: #032d60 in "color: #032d60;"

File: src/tenants/salesforce/VTOCampaign2024/index.tsx
------------------------------------------------------
- Line 30: white in "<main style={{ backgroundColor: 'white', paddingBottom: '60px' }}>"

File: src/tenants/salesforce/VTOCampaign2024/styles/AdditionalInfo.module.scss
------------------------------------------------------------------------------
- Line 23: #032d60 in "color: #032d60;"
- Line 46: #181818 in "color: #181818;"
- Line 52: #1a1a1a in "color: #1a1a1a;"
...
File: src/tenants/salesforce/VTOCampaign2024/styles/ContentSection.module.scss
------------------------------------------------------------------------------
- Line 22: #032d60 in "color: #032d60;"
- Line 55: #0b5cab in "color: #0b5cab;"

File: src/tenants/salesforce/VTOCampaign2024/styles/Landing.module.scss
-----------------------------------------------------------------------
- Line 50: #032d60 in "color: #032d60;"
- Line 95: #0176d3 in "background: #0176d3;"
- Line 103: #ffffff in "color: #ffffff;"

File: src/tenants/salesforce/VTOCampaign2024/styles/LeaderBoardSection.module.scss
----------------------------------------------------------------------------------
- Line 58: #080707 in "color: #080707;"
- Line 69: #032d60 in "color: #032d60;"
- Line 79: #f5f2f2 in "background-color: #f5f2f2;"
...
File: src/tenants/salesforce/VTOCampaign2024/styles/ProjectGrid.module.scss
---------------------------------------------------------------------------
- Line 13: #0176d3 in "background: #0176d3;"
- Line 21: #ffffff in "color: #ffffff;"
- Line 46: #032d60 in "color: #032d60;"

File: src/tenants/salesforce/VTOCampaign2025/index.tsx
------------------------------------------------------
- Line 30: white in "<main style={{ backgroundColor: 'white', paddingBottom: '60px' }}>"

File: src/tenants/salesforce/VTOCampaign2025/styles/AdditionalInfo.module.scss
------------------------------------------------------------------------------
- Line 23: #032d60 in "color: #032d60;"
- Line 46: #181818 in "color: #181818;"
- Line 52: #1a1a1a in "color: #1a1a1a;"
- Line 56: #0b5cab in "color: #0b5cab;"
- Line 59: white in "white-space: nowrap;"

File: src/tenants/salesforce/VTOCampaign2025/styles/ContentSection.module.scss
------------------------------------------------------------------------------
- Line 22: #032d60 in "color: #032d60;"
- Line 65: #0b5cab in "color: #0b5cab;"

File: src/tenants/salesforce/VTOCampaign2025/styles/Landing.module.scss
-----------------------------------------------------------------------
- Line 50: #032d60 in "color: #032d60;"
- Line 95: #0176d3 in "background: #0176d3;"
- Line 103: #ffffff in "color: #ffffff;"

File: src/tenants/salesforce/VTOCampaign2025/styles/LeaderBoardSection.module.scss
----------------------------------------------------------------------------------
- Line 61: #080707 in "color: #080707;"
- Line 72: #032d60 in "color: #032d60;"
- Line 82: #f5f2f2 in "background-color: #f5f2f2;"
- Line 135: #dddbda in "border-bottom: 1px solid #dddbda;"
- Line 147: #181818 in "color: #181818;"
- Line 168: #706e6b in "color: #706e6b;"
- Line 39: white in "background-color: white;"

File: src/tenants/salesforce/VTOCampaign2025/styles/ProjectGrid.module.scss
---------------------------------------------------------------------------
- Line 13: #0176d3 in "background: #0176d3;"
- Line 21: #ffffff in "color: #ffffff;"
- Line 46: #032d60 in "color: #032d60;"
...
---------------------------
- Line 48: #c8def4 in "// background-color: #c8def4;"
- Line 401: #f3f3f3 in "border: 2px solid #f3f3f3;"
- Line 494: #000000 in "box-shadow: 0px 3px 6px -3px rgba($color: #000000, $alpha: 0.26);"
- Line 720: #828282 in "color: #828282;"
- Line 41: rgba(0, 0, 0, 0.87) in "color: rgba(0, 0, 0, 0.87);"
- Line 313: rgba(0, 0, 0, 0.6) in "background: rgba(0, 0, 0, 0.6);"
...
------------------------------
- Line 27: rgba(0, 0, 0, 0.6) in "secondary: 'rgba(0, 0, 0, 0.6)',"

File: src/utils/constants/intervention.ts
-----------------------------------------
- Line 4: #007A49 in "const SINGLE_TREE = '#007A49';"
- Line 6: #EB5757 in "const INVASIVE_SPECIES = '#EB5757';"
- Line 7: #F2C94C in "const FIRE_SUPPRESSION = '#F2C94C';"
- Line 8: #F2994A in "const FIRE_PATROL = '#F2994A';"
- Line 9: #48AADD in "const FENCING = '#48AADD';"
- Line 10: #27AE60 in "const MARKING_REGENERANT = '#27AE60';"
- Line 11: #56CCF2 in "const LIBERATING_REGENERANT = '#56CCF2';"
- Line 12: #219653 in "const GRASS_SUPPRESSION = '#219653';"
- Line 13: #E86F56 in "const FIREBREAKS = '#E86F56';"
- Line 14: #2F80ED in "const SEED_RAIN = '#2F80ED';"
- Line 15: #6D4230 in "const SOIL_IMPROVEMENT = '#6D4230';"
- Line 16: #4F4F4F in "const STOP_HARVESTING = '#4F4F4F';"
- Line 17: #6FCF97 in "const DIRECT_SEEDING = '#6FCF97';"
- Line 18: #EB67CE in "const ENRICHMENT_PLANTING = '#EB67CE';"
- Line 19: #6C63FF in "const MAINTENANCE = '#6C63FF';"
- Line 20: #9B51E0 in "const OTHER_INTERVENTION = '#9B51E0';"

File: src/utils/mapsV2/mapSettings.config.ts
--------------------------------------------
- Line 80: #27AE60 in "color: '#27AE60',"
- Line 114: #EB5757 in "color: '#EB5757',"
- Line 130: #2F80ED in "color: '#2F80ED',"
...
- #202020
- #215ca0
- #219653, rgba(33, 150, 83, 0.08), rgba(33, 150, 83, 0.15), rgba(33, 150, 83, 0.2), rgba(33, 150, 83, 0.4)
- #231e1e
- #242424
- #26bde2
- #27AE60, #27ae60
...
- #688816
- #689f38
- #68B030, #68b030, rgba(104, 176, 48), rgba(104, 176, 48, 0.1), rgba(104, 176, 48, 0.12)
- #69882c
- #6aac35
- #6bab35
- #6C63FF, #6c63ff
...
- #729237
- #75953a
- #787878, rgba(120, 120, 120, 0.1)
- #78CD51
- #828282, rgba(130, 130, 130, 1)
- #848484
- #87b738
- #87ceeb
- #89B53A
...
- #b3aced
- #bc86ed
- #BDBDBD, #bdbdbd, rgba(189, 189, 189, 1)
- #be6f72
- #be8b87
- #BED1E6
- #bf8b2e
...
- #d6d6d9
- #D8E3F0
- #D9D9D9, #d9d9d9, rgba(217, 217, 217, 1)
- #dc3545
- #DC3F1F
- #dcdcdc
- #dce7ff
...
- #deffc4
- #DFF4E8
- #E0E0E0, #e0e0e0, rgba(224, 224, 224, 1)
- #e1efd6
- #e2eee8
- #e5243b
- #e53935
